...
public abstract class CustomBaseQuickAdapter <T, K extends BaseViewHolder> extends RecyclerView.Adapter<K>{
    //load more
    ...
    protected static final String TAG = CustomBaseQuickAdapter.class.getSimpleName();
    ...
    public CustomBaseQuickAdapter(int layoutResId, List<T> data) {
        this.mData = (LinkedList<T>) (data == null ? new LinkedList<>() : data);
        if (layoutResId != 0) {
            this.mLayoutResId = layoutResId;
        }
    }

    public CustomBaseQuickAdapter(List<T> data) {
        this(0, data);
    }

    public CustomBaseQuickAdapter(int layoutResId) {
     ...
     * @param data
     */
    public void setNewData(LinkedList<T> data) {
        this.mData = data == null ? (LinkedList<T>) new LinkedList<>() : data;
