...
import static com.bigscreen.fatawowinmalamai.Adapters.CustomBaseQuickAdapter.EMPTY_VIEW;
import static com.bigscreen.fatawowinmalamai.Adapters.CustomBaseQuickAdapter.FOOTER_VIEW;
import static com.bigscreen.fatawowinmalamai.Adapters.CustomBaseQuickAdapter.HEADER_VIEW;
import static com.bigscreen.fatawowinmalamai.Adapters.CustomBaseQuickAdapter.LOADING_VIEW;
...
public abstract class CustomSimpleClickListner implements RecyclerView.OnItemTouchListener{
    private GestureDetectorCompat mGestureDetector;
    private RecyclerView recyclerView;
    protected CustomBaseQuickAdapter baseQuickAdapter;
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        if (recyclerView == null) {
            ...
            this.baseQuickAdapter = (CustomBaseQuickAdapter) recyclerView.getAdapter();
...
//                mPressedView.setPressed(true);
     ...
     */
    public abstract void onItemClick(CustomBaseQuickAdapter adapter, View view, int position);
     ...
     */
    public abstract void onItemLongClick(CustomBaseQuickAdapter adapter, View view, int position);

    public abstract void onItemChildClick(CustomBaseQuickAdapter adapter, View view, int position);

    public abstract void onItemChildLongClick(CustomBaseQuickAdapter adapter, View view, int position);
    ...
    private boolean isHeaderOrFooterPosition(int position) {
        ...
        if (baseQuickAdapter==null){
            if (recyclerView!=null){
                baseQuickAdapter= (CustomBaseQuickAdapter) recyclerView.getAdapter();
            }else {
                return false;
            }
        }
