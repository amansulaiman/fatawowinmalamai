...
public class Fatawa implements Serializable{
    ...
    private String malamiID;

    public Fatawa(boolean anYijawabi, String jawabinMalami, String sunanTambaya, String jawabinTambaya, String maiTambaya, Date lokacinTambaya, String sunanMalami, String malamiID) {
        ...
        this.malamiID = malamiID;
    }

    public Fatawa() {
    }

    public String getMalamiID() {
        return malamiID;
    }

    public void setMalamiID(String malamiID) {
        this.malamiID = malamiID;
    }
